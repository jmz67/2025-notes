...
在 React 的早期版本中，把状态集中放在组件树的根部是一个重要的模式，让我们受益良多。作为 React 开发者，我们都应该掌握如何通过属性在组件树中向上和向下传递状态。然而，随着 React 的发展，以及组件树枝繁叶茂，遵守这个原则慢慢变得不切实际，对于很多开发者来说，在复杂的应用中集中于组件树的根部维护zhuan
